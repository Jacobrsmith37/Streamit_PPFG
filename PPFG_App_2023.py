...
def interactive_plot():
    ...
    df_topset = df_topset.astype({"MD":"int"})
...
# Create a column for Frac Gradient PSI and then create a column for Frac Gradient PPG with simple conversion
  ...
  #add in for pore pressure 02/2024
    ...
    plot.text_input(0.5, -0.1, f"Date: {datetime.today().strftime('%m-%d-%Y')}", ha = 'center' , va = 'top', fontsize = 12 )
...
#     plot.add_hline(y = int(pierre_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'Pierre', annotation_position = 'top left')
    plot.add_hline(y = int(greenhorn_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'GREENHORN', annotation_xshift = 10, annotation_position = 'top left')
...
#     plot.add_hline(y = int(mowry_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'Mowry', annotation_position = 'top left')
    plot.add_hline(y = int(inyan_kara_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'INYAN_KARA',annotation_xshift = 10, annotation_position = 'top left')
    plot.add_hline(y = int(spearfish_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'SPEARFISH',annotation_xshift = 10, annotation_position = 'top left')
    plot.add_hline(y = int(swift_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'SWIFT', annotation_xshift = 10,annotation_position = 'top left')
    plot.add_hline(y = int(rierdon_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'RIERDON', annotation_xshift = 10,annotation_position = 'top left')
    plot.add_hline(y = int(amsden_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'AMSDEN',annotation_xshift = 10, annotation_position = 'top left')
#     plot.add_hline(y = int(tyler_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'Tyler', annotation_position = 'top left')
    plot.add_hline(y = int(kibbey_lime_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'KIBBEY_LIME',annotation_xshift = 10, annotation_position = 'top left')
    plot.add_hline(y = int(charles_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'CHARLES', annotation_xshift = 10,annotation_position = 'top left')
    plot.add_hline(y = int(top_last_salt_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'TOP_LAST_SALT',annotation_xshift = 10, annotation_position = 'top left')
#  #   plot.add_hline(y = int(base_last_salt_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'Base Last Salt', annotation_position = 'top left')
    plot.add_hline(y = int(frobisher_alida_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'FROBISHER_ALIDA_INTERVAL', annotation_xshift = 10,annotation_position = 'top left')
    plot.add_hline(y = int(upper_bakken_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'UPPER_BAKKEN_SHALE', annotation_xshift = 10,annotation_position = 'top left')
...
#     plot.add_hline(y = int(birdbear_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'Birdbear', annotation_position = 'top left')
    ...
    plot.update_annotations(xshift = 10, font=dict(size=10, color='#037F57'))
