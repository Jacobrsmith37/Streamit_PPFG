...
#     plot.add_hline(y = int(pierre_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'Pierre', annotation_position = 'top left')
    plot.add_hline(y = int(greenhorn_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'GREENHORN', annotation_text_size = 5, annotation_position = 'top left')
...
#     plot.add_hline(y = int(tyler_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'Tyler', annotation_position = 'top left')
    ...
    plot.add_hline(y = int(top_last_salt_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'TOP_LAST_SALT', annotation_position = 'top left')
#  #   plot.add_hline(y = int(base_last_salt_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'Base Last Salt', annotation_position = 'top left')
    plot.add_hline(y = int(frobisher_alida_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'FROBISHER_ALIDA_INTERVAL', annotation_position = 'top left')
    plot.add_hline(y = int(upper_bakken_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'UPPER_BAKKEN_SHALE', annotation_position = 'top left')
