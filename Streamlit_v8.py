...
# greenhorn1 = Topset1[Topset1['TopName'] == 'Greenhorn']
# belle_fourche1 = Topset1[Topset1['TopName'] == 'Belle_Fourche']
# mowry1 = Topset1[Topset1['TopName'] == 'Mowry']
...
def home(uploaded_file):
    if uploaded_file:
        ...
        st.header('To begin please upload a Topset csv file, then navigate to ' '''Jacob Plots''')
...
def interactive_plot():
    ...
    st.text('*** 0 is equal to an ignored value ***')
# Standard Variables
...
#             st.write(
#             LS_inyan_kara = st.number_input('Inyan Kara LS',value = 3600),
