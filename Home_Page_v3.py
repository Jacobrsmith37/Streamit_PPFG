...
#     plot.add_hline(y = int(pierre_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'Pierre', annotation_position = 'top left')
    plot.add_hline(y = int(greenhorn_upload['TVD']), line_dash="dash", row=1, col="all", annotation_text = 'GREENHORN', annotation_position = 'top left')
...
#     plot.add_hline(y = int(mowry_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'Mowry', annotation_position = 'top left')
    plot.add_hline(y = int(inyan_kara_upload['TVD']), line_dash="dash", row=1, col="all", annotation_text = 'INYAN_KARA', annotation_position = 'top left')
    plot.add_hline(y = int(swift_upload['TVD']), line_dash="dash", row=1, col="all", annotation_text = 'SWIFT', annotation_position = 'top left')
    plot.add_hline(y = int(rierdon_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'RIERDON', annotation_position = 'top left')
    plot.add_hline(y = int(amsden_upload['TVD']), line_dash="dash", row=1, col="all", annotation_text = 'AMSDEN', annotation_position = 'top left')
#     plot.add_hline(y = int(tyler_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'Tyler', annotation_position = 'top left')
    plot.add_hline(y = int(kibbey_lime_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'KIBBEY_LIME', annotation_position = 'top left')
    plot.add_hline(y = int(charles_upload['TVD']), line_dash="dash", row=1, col="all", annotation_text = 'CHARLES', annotation_position = 'top left')
    plot.add_hline(y = int(top_last_salt_upload['TVD']), line_dash="dash", row=1, col="all", annotation_text = 'TOP_LAST_SALT', annotation_position = 'top left')
#  #   plot.add_hline(y = int(base_last_salt_upload['TVD']), line_dash="dot", row=1, col="all", annotation_text = 'Base Last Salt', annotation_position = 'top left')
    plot.add_hline(y = int(frobisher_alida_upload['TVD']), line_dash="dash", row=1, col="all", annotation_text = 'FROBISHER_ALIDA_INTERVAL', annotation_position = 'top left')
    plot.add_hline(y = int(upper_bakken_upload['TVD']), line_dash="dash", row=1, col="all", annotation_text = 'UPPER_BAKKEN_SHALE', annotation_position = 'top left')
